...
function HavingCard(props) {
    return(
        <span style={Object.assign({}, props.style, { margin: 5 })}>
            ...
            <img style={{width:50, height: 70, resizeMode: 'contain'}} src={ ColoredBackCardImageList.tier1[props.imgIndx] }/>
        </span>
    )
}
    ...
    return (
        <span>
            <div style={{display: "flex"}}>
                ...
                <HavingCard havingList={ [1, 0, 0] } imgIndx={ WHITE_TOKEN_INDEX } number={1} style={{flex: 1}} />
                <HavingCard havingList={ [1, 0, 0] } imgIndx={ BLUE_TOKEN_INDEX } number={1} style={{flex: 1}} />
                <HavingCard havingList={ [1, 0, 0] } imgIndx={ GREEN_TOKEN_INDEX } number={1} style={{flex: 1}} />
            </div>
            <div style={{display: "flex"}}>
                ...
                <HavingCard havingList={ [1, 0, 0] } imgIndx={ RED_TOKEN_INDEX } number={1} style={{flex: 1}} />
                <HavingCard havingList={ [1, 0, 0] } imgIndx={ BLACK_TOKEN_INDEX } number={1} style={{flex: 1}} />
            </div>
        </span>
    )
}
